...
//#define LCD_SHOW_E_TOTAL
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //GREG v2.1
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
    ...
    #define BABYSTEP_ALWAYS_AVAILABLE     // Allow babystepping at all times (not just during movement). //GREG v2.1
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //GREG v2.1
...
#define RX_BUFFER_SIZE 2048 //GREG v2.1

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF //GREG v2.1
#endif
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      800 //GREG v2.1
    #define E0_MICROSTEPS    16
   ...
   */
  #define MONITOR_DRIVER_STATUS //GREG v2.1
